      ...
      >
        <v-list-item>
          <v-list-item-title>
            <v-expansion-panels accordion>
              <v-expansion-panel>
                <v-expansion-panel-header>Inicio</v-expansion-panel-header>
                <v-expansion-panel-content>
                  <v-list nav dense>
                    ...
                    >
                      <v-list-item>
                        <v-list-item-title>
                          <router-link to="/Crear_Cuenta">Crear_Cuenta</router-link>
                        </v-list-item-title>
                      </v-list-item>
            ...
            <v-expansion-panels accordion>
              <v-expansion-panel>
                <v-expansion-panel-header
                  >Busqueda</v-expansion-panel-header
                >
                <v-expansion-panel-content>
                  <v-list nav dense>
                    <v-list-item-group
        ...
        <v-list-item>
          <v-list-item-title>
            <v-expansion-panels accordion>
              <v-expansion-panel>
                <v-expansion-panel-header>Compras</v-expansion-panel-header>
                <v-expansion-panel-content>
                  <v-list nav dense>
                    <v-list-item-group
                      v-model="group"
                    ...
                    >
                      ...
                      <v-list-item>
                        <v-list-item-title>
                          <router-link to="/Easy_Pay">Easy_Pay</router-link>
                        </v-list-item-title>
                      </v-list-item>
